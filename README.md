...
This website is statically deployed to GitHub Pages using:
- **HTML5 & CSS3 / SCSS**: Clean, mobile-responsive layout.
- **JavaScript**: jQuery, `jquery.scrollex` (scroll monitoring), `jquery.scrolly` (smooth scrolling).
- **Responsive Breakpoints**: Custom desktop sticky nav and mobile fixed header with scroll-padding.
...
To test or view the website locally on your computer:

1. **Clone the repository**:
   ```bash
   git clone https://github.com/AnasSayed27/AnasSayed27.github.io.git
   cd AnasSayed27.github.io
   ```

2. **Launch a local static server** (Python 3):
   ```bash
...
- **Base Template**: Customized variant of *Stellar* designed by [AJ](https://twitter.com/ajlkn) for [HTML5 UP](https://html5up.net).
- **License**: Creative Commons Attribution 3.0 Unported ([CCA 3.0](https://html5up.net/license)).
- **Icons**: [Font Awesome](https://fontawesome.com).
- **Fonts**: [Source Sans Pro](https://fonts.google.com/specimen/Source+Sans+Pro) via Google Fonts.

---

&copy; Anas Sayed. All rights reserved.
